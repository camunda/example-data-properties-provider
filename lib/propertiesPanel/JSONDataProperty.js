...
const JSONDataProperty = (props) => {
  ...
  return TextAreaEntry({
    ...
    description: translate('A map of variables provided to the engine upon task completion. If specified, it is used to provide variable suggestions in output mappings and/or the process. Must be a valid JSON object.'),
    id: 'exampleJson',
    getValue,
    setValue,
    debounce,
